...
const mccConceptsELM = require('../../input/cql/MCCConcepts.json');
const fhirCommonELM = require('../../input/cql/FHIRCommon.json');
const fhirHelpersELM = require('../../input/cql/FHIRHelpers.json');
